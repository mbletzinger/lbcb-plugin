...
p.InputPort 		= 11997;		    	% Connection port from UI-SimCor, use LabView2 protocol
                	
p.CtrlMode  		= 1;				% Control mode, 1 for displacement, 2 for mixed.
...
p.M_LBCB_Disp     = zeros(6,1);                       % Measured disp at each step, Num_DOFx1
p.M_LBCB_Forc     = zeros(6,1);                       % Measured force at each step, Num_DOFx1
...
p.Aux_Config.LBCB_Ht =  0;
p.Aux_Config.Roof_Ht =  0;
