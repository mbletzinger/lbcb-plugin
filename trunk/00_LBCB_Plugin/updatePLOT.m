...
% LBCB Step
if get(handles.RB_PlotData_LBCBStep,      'value')
	CurStepNo      = handles.MDL.curStep;
	LBCB_Tar_Data  = handles.MDL.tDisp_history;
	LBCB_Mea_Displ = handles.MDL.mDisp_history;
	LBCB_Mea_Force = handles.MDL.mForc_history;
	Model_Tar_Data = handles.MDL.tDisp_history_SC;

else % Model Step
	CurStepNo      = handles.MDL.StepNos;
	LBCB_Tar_Data  = handles.MDL.Model_tDisp_history;
	LBCB_Mea_Displ = handles.MDL.Model_mDisp_history;
	LBCB_Mea_Force = handles.MDL.Model_mForc_history;
	Model_Tar_Data = handles.MDL.Model_tDisp_history_SC;
end
...
if handles.MDL.curState == 3				% result received (end of each step)
	McurStep = CurStepNo;			% current step of measured data
else
	McurStep = CurStepNo-1;		% current step of measured data
end
