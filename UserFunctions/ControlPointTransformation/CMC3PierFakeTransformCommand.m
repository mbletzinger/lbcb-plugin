function lbcbTgts = CMC3PierFakeTransformCommand(me,mdlTgts)  
...
cmd_fake_3pier = [mdlTgts{1}.disp(1),mdlTgts{1}.disp(2),mdlTgts{1}.disp(3),mdlTgts{1}.disp(4),mdlTgts{1}.disp(5),mdlTgts{1}.disp(6)];
fprintf(1,'rev cmd: %6.3f %6.3f %6.3f %6.3f %6.3f %6.3f\n',cmd_fake_3pier);
